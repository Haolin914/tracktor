...
class Tracker:
    ...
    def step(self, blob):
        ...
        ###########################
        # device = torch.device('cpu') #if torch.npu.is_available() else torch.device('cpu')
        ...
        if self.public_detections:
            ...
            if dets.nelement() > 0:
                ...
                boxes = scores = torch.zeros(0).npu(2)
        else:
